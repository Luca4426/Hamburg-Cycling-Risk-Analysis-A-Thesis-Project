...
# SCRIPT: Normalize Traffic Volume (DTV) - Model 4 (Grid-based)
# DATE: 23.11.2025
# DESCRIPTION: Applies Min-Max normalization (0-1 scaling) to 
#	       the Car_DTV_Grid column for machine learning model preparation.
# ===================================================================
...
# ===================================================================
print_header('TRAFFIC VOLUME NORMALIZATION - Model 4')

# Input/Output paths
INPUT_CSV = "Acc_250Grid_HH_enhanced_grid_classified.csv"
OUTPUT_CSV = "Acc_250Grid_HH_enhanced_final.csv"

# Column to normalize
COLUMN_NAME = "Car_DTV_Grid"
